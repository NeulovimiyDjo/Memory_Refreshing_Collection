...
using ProxyServerML.Model;

namespace ProxyServerML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Andrey\Desktop\ProxyServer\Data\data.csv";
        private static string MODEL_FILEPATH = @"C:\Users\Andrey\AppData\Local\Temp\MLVSTools\ProxyServerML\ProxyServerML.Model\MLModel.zip";
